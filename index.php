...
<link rel="stylesheet" href="/ui/tg-forms/tg-form-modal.css?v=<?= $buildVersion ?>">
...
<script src="/ui/tg-notify/form-autotrack.js?v=<?php echo time(); ?>"></script>
<script src="/ui/tg-forms/tg-form-modal.js?v=<?php echo time(); ?>"></script>
