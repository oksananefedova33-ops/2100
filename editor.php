...
<!-- HTML Preview Videos Module -->
<link rel="stylesheet" href="/ui/html-preview-videos/html-preview-videos.css?v=<?php echo date('YmdHis'); ?>" />
<script src="/ui/html-preview-videos/html-preview-videos.js?v=<?php echo date('YmdHis'); ?>"></script>
</head><body>
<div class="topbar">
...
<!-- === TG Form Generator (кнопка Форма → TG) === -->
<script defer src="/ui/tg-forms/tg-form-generator.js?v=<?php echo date('YmdHis'); ?>"></script>
<script defer src="/ui/tg-forms/tg-form-presets.js?v=<?php echo date('YmdHis'); ?>"></script>
<script defer src="/ui/tg-forms/tg-form-generator-integration.js?v=<?php echo date('YmdHis'); ?>"></script>
...
<script src="/ui/export-stats-domain/export-stats-domain.js?v=<?php echo date('YmdHis'); ?>"></script>
<!-- Ключевые слова, author и Breadcrumbs -->
<script src="/ui/export-keywords/export-keywords.js?v=<?php echo date('YmdHis'); ?>"></script>
<link  rel="stylesheet" href="/ui/export-gpt/export-gpt.css?v=<?php echo date('YmdHis'); ?>">
<script src="/ui/export-gpt/export-gpt.js?v=<?php echo date('YmdHis'); ?>"></script>
...
<!-- Модуль отправок форм -->
<link rel="stylesheet" href="/ui/form-submissions/form-submissions.css?v=<?php echo date('YmdHis'); ?>">
<script src="/ui/form-submissions/form-submissions.js?v=<?php echo date('YmdHis'); ?>"></script>
